 ...
 */
@Getter
public enum StrixCaptchaRepCodeEnum {
    ...
    StrixCaptchaRepCodeEnum(String code, String desc) {
        this.code = code;
        this.desc = desc;
    }
     ...
     * @return 错误信息
     */
    public StrixCaptchaResp parseError(Object... fieldNames) {
        StrixCaptchaResp errorMessage = new StrixCaptchaResp();
